...
class HrEmployee(models.Model):
    ...
    emp_social_twitter = fields.Char(string="Twitter account",
                                     default="https://twitter.com/", translate=True)
    emp_social_facebook = fields.Char(
        string="Facebook account", default="https://www.facebook.com/", translate=True)
    emp_social_linkdin = fields.Char(
        string="Linkedin account", default="https://www.linkedin.com/company/", translate=True)
