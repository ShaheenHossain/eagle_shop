...
class CrafitoSliderSettings(http.Controller):
    ...
    @http.route(['/eagle_shop/blog_get_options'], type='json', auth="public", website=True)
    ...
    @http.route(['/eagle_shop/blog_get_dynamic_slider'], type='http', auth='public', website=True)
    def crafito_get_dynamic_slider(self, **post):
        if post.get('slider-type'):
            ...
            return request.render("eagle_shop.eagle_shop_blog_slider_view", values)

    @http.route(['/eagle_shop/blog_image_effect_config'], type='json', auth='public', website=True)
    ...
    # For Client slider
    @http.route(['/eagle_shop/get_clients_dynamically_slider'], type='http', auth='public', website=True)
    def get_clients_dynamically_slider(self, **post):
        ...
        return request.render("eagle_shop.eagle_shop_client_slider_view", values)

    # For multi product slider
    @http.route(['/eagle_shop/product_multi_get_options'], type='json', auth="public", website=True)
    ...
    @http.route(['/eagle_shop/product_multi_get_dynamic_slider'], type='http', auth='public', website=True)
    def crafito_product_multi_get_dynamic_slider(self, **post):
        ...
        if post.get('slider-type'):
            ...
            return request.render("eagle_shop.eagle_shop_multi_cat_slider_view", values)

    @http.route(['/eagle_shop/product_multi_image_effect_config'], type='json', auth='public', website=True)
    ...
    @http.route(['/eagle_shop/newsone_get_dynamic_slider'], type='http', auth='public', website=True)
    def crafito_get_dynamic_newsone_slider(self, **post):
        if post.get('slider-type'):
            ...
            return request.render("eagle_shop.eagle_shop_news1_view", values)

    @http.route(['/eagle_shop/newstwo_get_dynamic_slider'], type='http', auth='public', website=True)
    def crafito_get_dynamic_newstwo_slider(self, **post):
        if post.get('slider-type'):
            ...
            return request.render("eagle_shop.eagle_shop_news2_view", values)

    @http.route(['/eagle_shop/theme_new_hardware_blog'], type='http', auth='public', website=True)
    ...
    def get_employee_detail_custom_1(self, **post):
        emp = self.find_snippet_employee()
        return request.render("eagle_shop.eagle_shop_team_three", emp)

    # For Category slider
    @http.route(['/eagle_shop/category_get_options'], type='json', auth="public", website=True)
    ...
    @http.route(['/eagle_shop/category_get_dynamic_slider'], type='http', auth='public', website=True)
    def category_get_dynamic_slider(self, **post):
        if post.get('slider-id'):
            ...
            return request.render("eagle_shop.eagle_shop_cat_slider_view", values)

    @http.route(['/eagle_shop/category_image_effect_config'], type='json', auth='public', website=True)
    ...
    def get_factsheet_data(self, **post):
        return request.render("eagle_shop.eagle_shop_facts_sheet_view")

    @http.route(['/biztech_skill_model_data/skill_data'], type="http", auth="public", website="True")
    def get_skill_data(self, **post):
        return request.render("eagle_shop.eagle_shop_skills_view")

    # Multi image gallery
    @http.route(['/eagle_shop/crafito_multi_image_effect_config'], type='json', auth="public", website=True)
    ...
    # For Product slider
    @http.route(['/eagle_shop/product_get_options'], type='json', auth="public", website=True)
    ...
    @http.route(['/eagle_shop/product_get_dynamic_slider'], type='http', auth='public', website=True)
    def product_get_dynamic_slider(self, **post):
        if post.get('slider-id'):
            ...
            return request.render("eagle_shop.eagle_shop_product_slider_view", values)

    @http.route(['/eagle_shop/product_image_effect_config'], type='json', auth='public', website=True)
    ...
    @http.route(['/eagle_shop/featured_product_get_options'], type='json', auth="public", website=True)
    ...
    @http.route(['/eagle_shop/featured_product_get_dynamic_slider'], type='http', auth='public', website=True)
    def featured_product_get_dynamic_slider(self, **post):
        ...
        if post.get('slider-id'):
            ...
            return request.render("eagle_shop.eagle_shop_featured_product_slider_view", values)

    @http.route(['/eagle_shop/featured_product_image_effect_config'], type='json', auth='public', website=True)
    ...
    @http.route(['/eagle_shop/event_slider/get_data'], type="http", auth="public", website=True)
    def get_event_data(self, **post):
        events = request.env['event.type'].sudo().search([])
        values = {'main_events_category': events}
        return request.render("eagle_shop.eagle_shop_events_view", values)
...
class CrafitoEcommerceShop(WebsiteSale):
    ...
    def cart_update_json(self, product_id, line_id=None, add_qty=None, set_qty=None, display=True):
        ...
        result.update({'eagle_shop.hover_total': request.env['ir.ui.view'].render_template("eagle_shop.hover_total", {
    ...
    def shop(self, page=0, category=None, search='', ppg=False, **post):
        ...
        is_price_slider = request.env.ref('eagle_shop.product_price_slider')
