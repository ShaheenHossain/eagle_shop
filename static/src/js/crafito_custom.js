odoo.define('eagle_shop.crafito_custom_js', function(require) {
    'use strict';
    ...
    $(document).ready(function($) {
        ...
        // Multi image gallery
        var api;
        ajax.jsonRpc('/eagle_shop/crafito_multi_image_effect_config', 'call', {})
            .done(function(res) {
                var dynamic_data = {}
        ...
        $('.oe_website_sale').each(function() {
            ...
            $(oe_website_sale).on("change", ".oe_cart input.js_quantity[data-product-id]", function() {
                ...
                clickwatch(function() {
                    ...
                    var $q1 = $(".eagle_shop_cart_quantity");
                    if (value) {
                        $q1.parent().parent().removeClass("hidden");
                    } else {
                        $q1.parent().parent().find('.eagle_shop_cart_quantity').html(0)
                    ...
                    ajax.jsonRpc("/shop/cart/update_json", 'call', {
                        ...
                        var my_hover_total = setInterval(function(){
                            ...
                            $("#crafito_hover_total").empty().html(data['eagle_shop.hover_total']);
