odoo.define('eagle_shop.crafito_editor_js', function(require) {
    'use strict';
    ...
    ajax.loadXML('/eagle_shop/static/src/xml/eagle_shop.xml', qweb);
    ...
    options.registry.eagle_shop_blog_custom_snippet = options.Class.extend({
        start: function(editMode) {
            ...
            if (!editMode) {
                self.$el.find(".crafito_blog_slider").on("click", _.bind(self.eagle_shop_blog_slider, self));
            }
        },
        onBuilt: function() {
            var self = this;
            this._super();
            if (this.eagle_shop_blog_slider()) {
                this.eagle_shop_blog_slider().fail(function() {
        ...
        eagle_shop_blog_slider: function(type, value) {
            var self = this;
            if (type != undefined && type.type == "click" || type == undefined) {
                self.$modal = $(qweb.render("eagle_shop.crafito_blog_slider_block"));
                ...
                ajax.jsonRpc('/eagle_shop/blog_get_options', 'call', {}).done(function(res) {
    ...
    options.registry.eagle_shop_multi_cat_custom_snippet = options.Class.extend({
        ...
        multi_category_slider: function(type, value) {
            var self = this;
            if (type != undefined && type.type == "click" || type == undefined) {
                self.$modal = $(qweb.render("eagle_shop.multi_product_custom_slider_block"));
                self.$modal.appendTo('body');
                self.$modal.modal();
                ...
                ajax.jsonRpc('/eagle_shop/product_multi_get_options', 'call', {}).done(function(res) {
    ...
    options.registry.eagle_shop_coming_soon_mode_one = options.Class.extend({
        start: function(editMode) {
            var self = this;
            this._super();
            this.$target.removeClass("hidden");
            ...
            if (!editMode) {
                self.$el.find(".biztech_coming_soon_mode_one").on("click", _.bind(self.eagle_shop_coming_soon_mode_one_function, self));
            }
        },
        ...
        onBuilt: function() {
            var self = this;
            this._super();
            if (this.eagle_shop_coming_soon_mode_one_function()) {
                self.eagle_shop_coming_soon_mode_one_function.fail(function() {
                    self.getParent()._removeSnippet();
                });
            }
        },
        ...
        eagle_shop_coming_soon_mode_one_function: function(type, value) {
            if (type != undefined && type.type == "click" || type == undefined) {
                var self = this;
                self.$modal = $(qweb.render("eagle_shop.model_dialog_commingsoon"));
                self.$modal.appendTo('body');
                self.$modal.modal();
    ...
    options.registry.eagle_shop_coming_soon_mode_two = options.Class.extend({
        start: function(editMode) {
            var self = this;
            this._super();
            this.$target.removeClass("hidden");
            ...
            if (!editMode) {
                self.$el.find(".biztech_coming_soon_mode_two").on("click", _.bind(self.eagle_shop_coming_soon_mode_two_function, self));
            }
        },
        ...
        onBuilt: function() {
            var self = this;
            this._super();
            if (this.eagle_shop_coming_soon_mode_two_function()) {
                self.eagle_shop_coming_soon_mode_two_function.fail(function() {
                    self.getParent()._removeSnippet();
                });
            }
        },
        ...
        eagle_shop_coming_soon_mode_two_function: function(type, value) {
            if (type != undefined && type.type == "click" || type == undefined) {
                var self = this;
                self.$modal = $(qweb.render("eagle_shop.model_dialog_commingsoon"));
                self.$modal.appendTo('body');
    ...
    options.registry.eagle_shop_category_slider = options.Class.extend({
        start: function(editMode) {
            var self = this;
            this._super();
            this.$target.removeClass("hidden");
        ...
        cat_slider: function(type, value) {
            var self = this;
            if (type != undefined && type.type == "click" || type == undefined) {
                self.$modal = $(qweb.render("eagle_shop.crafito_dynamic_category_slider"));
                self.$modal.appendTo('body');
                self.$modal.modal();
                var $slider_type = self.$modal.find("#slider_type"),
                ...
                ajax.jsonRpc('/eagle_shop/category_get_options', 'call', {}).done(function(res) {
    ...
    options.registry.eagle_shop_product_slider = options.Class.extend({
        start: function(editMode) {
            var self = this;
            this._super();
            this.$target.removeClass("hidden");
        ...
        prod_slider: function(type, value) {
            var self = this;
            if (type != undefined && type.type == "click" || type == undefined) {
                self.$modal = $(qweb.render("eagle_shop.crafito_dynamic_product_slider"));
                self.$modal.appendTo('body');
                self.$modal.modal();
                var $slider_type = self.$modal.find("#slider_type"),
                ...
                ajax.jsonRpc('/eagle_shop/product_get_options', 'call', {}).done(function(res) {
                    $('#slider_type option[value!="0"]').remove();
                    _.each(res, function(y) {
                        $("select[id='slider_type'").append($('<option>', {
                            value: y["id"],
    ...
    options.registry.eagle_shop_featured_product_slider = options.Class.extend({
        start: function(editMode) {
            var self = this;
            this._super();
            this.$target.removeClass("hidden");
        ...
        featured_prod_slider: function(type, value) {
            var self = this;
            if (type != undefined && type.type == "click" || type == undefined) {
                self.$modal = $(qweb.render("eagle_shop.crafito_dynamic_featured_product_slider"));
                self.$modal.appendTo('body');
                self.$modal.modal();
                ...
                ajax.jsonRpc('/eagle_shop/featured_product_get_options', 'call', {}).done(function(res) {
                    $('#slider_type option[value!="0"]').remove();
                    _.each(res, function(y) {
    ...
    options.registry.biztech_new_theme_fact_sheet_jsselector = options.Class.extend({
        ...
        biztech_fact_sheet_function: function(type) {
            if (type != undefined && type.type == "click" || type == undefined) {
                var self = this;
                var factcount
                self.$modal = $(qweb.render("eagle_shop.crafito_dynami_fact_sheet"));
                self.$modal.appendTo('body');
                self.$modal.modal();
    ...
    options.registry.biztech_new_theme_skill_jsselector = options.Class.extend({
        ...
        biztech_new_theme_skill_function: function(type) {
            if (type != undefined && type.type == "click" || type == undefined) {
                var self = this;
                var skillcount
                self.$modal = $(qweb.render("eagle_shop.crafito_dyanamic_skill"));
                self.$modal.appendTo('body');
                self.$modal.modal();
    ...
    options.registry.eagle_shop_news1_js = options.Class.extend({
        start: function(editMode) {
            var self = this;
            this._super();
            this.$target.removeClass("hidden");
            ...
            if (!editMode) {
                self.$el.find(".crafito_newsone_slider").on("click", _.bind(self.eagle_shop_newsone_slider, self));
            }
        },
        onBuilt: function() {
            var self = this;
            this._super();
            if (this.eagle_shop_newsone_slider()) {
                this.eagle_shop_newsone_slider().fail(function() {
                    self.getParent()._removeSnippet();
                });
            }
        },
        ...
        eagle_shop_newsone_slider: function(type, value) {
            var self = this;
            if (type != undefined && type.type == "click" || type == undefined) {
                self.$modal = $(qweb.render("eagle_shop.crafito_blog_slider_block"));
                self.$modal.appendTo('body');
    ...
    options.registry.eagle_shop_news2_js = options.Class.extend({
        start: function(editMode) {
            var self = this;
            this._super();
            this.$target.removeClass("hidden");
            ...
            if (!editMode) {
                self.$el.find(".crafito_newstwo_slider").on("click", _.bind(self.eagle_shop_newstwo_slider, self));
            }
        },
        onBuilt: function() {
            var self = this;
            this._super();
            if (this.eagle_shop_newstwo_slider()) {
                this.eagle_shop_newstwo_slider().fail(function() {
                    self.getParent()._removeSnippet();
                });
            }
        },
        ...
        eagle_shop_newstwo_slider: function(type, value) {
            var self = this;
            if (type != undefined && type.type == "click" || type == undefined) {
                self.$modal = $(qweb.render("eagle_shop.crafito_blog_slider_block"));
                self.$modal.appendTo('body');
    ...
    options.registry.eagle_shop_hardware_blog_snippet = options.Class.extend({
        start: function(editMode) {
            var self = this;
            this._super();
            this.$target.removeClass("hidden");
            this.$target.find('.eagle_shop_new_blog').empty();
            if (!editMode) {
                self.$el.find(".eagle_shop_new_blog").on("click", _.bind(self.eagle_shop_new_blog_function, self));
            }
        },
        onBuilt: function() {
            var self = this;
            this._super();
            if (this.eagle_shop_new_blog_function()) {
                this.eagle_shop_new_blog_function().fail(function() {
                    self.getParent()._removeSnippet();
                });
            }
        },
        ...
        cleanForSave: function() {
            $('.eagle_shop_new_blog').empty();
        },

        eagle_shop_new_blog_function: function(type, value) {
            var self = this;
            if (type != undefined && type.type == "click" || type == undefined) {
                self.$modal = $(qweb.render("eagle_shop.crafito_blog_slider_block"));
                self.$modal.appendTo('body');
    ...
    options.registry.eagle_shop_faq_three_tabing = options.Class.extend({
        start: function() {
            var self = this;
    ...
    options.registry.eagle_shop_faq_one_tabing = options.Class.extend({
        start: function() {
            var self = this;
